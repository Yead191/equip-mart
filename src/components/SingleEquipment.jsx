        ...
        <div>
            ...
            <div className="h-[280px] bg-[#2d248a] relative">
                <Fade cascade damping={0.2}>
                    <h1 className="text-3xl lg:text-4xl font-bold text-center text-white pt-8">
                        Product Details
                    </h1>
                </Fade>
            </div>
            ...
            <motion.div
                ...
                className="md:w-8/12 md:mx-auto relative -mt-44 mb-28 mx-3"
            >
                            ...
                            <div className="mt-8 flex items-center gap-4">
                                {stockStatus > 0 ? (
                                    <button
                                        disabled={isCart}
                                        onClick={handleCart}
                                        className="btn bg-[#2d248a] text-white px-7"
                                    >
                                        Add to Cart
                                    </button>
                                ) : (
